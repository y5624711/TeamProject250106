...
CREATE TABLE TB_EMPMST (
                           ...
                           employee_common_code VARCHAR(5) NOT NULL REFERENCES TB_SYSCOMM(common_code) ON UPDATE CASCADE,
                           employee_workplace_code VARCHAR(6) NOT NULL ,
                           employee_no VARCHAR(9) NOT NULL unique ,
                           employee_password VARCHAR(20) DEFAULT '1234',
                           employee_name VARCHAR(5) NOT NULL,
                           employee_tel VARCHAR(13) NOT NULL,
...
ALTER TABLE TB_EMPMST
    MODIFY COLUMN employee_tel VARCHAR(13) NULL;
